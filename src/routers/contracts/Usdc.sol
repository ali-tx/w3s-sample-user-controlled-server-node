...
contract SepoliaUSDCSplitter {
    ...
    address private constant RECEIVE_WALLET = 0x105fe877e09F1eeEA65a2Cc407a9df5942E4737F;
    ...
    function splitETH(uint256 amount) public returns (bool) {
        ...
        (bool success,) = payable(FEE_WALLET).call{value: fee}("");
        require(success, "Fee transfer failed");
        // Send remainder to RECEIVE_WALLET
        (success,) = payable(RECEIVE_WALLET).call{value: remaining}("");
