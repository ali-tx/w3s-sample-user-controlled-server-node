...
describe('signUp', () => {
    test('Should return 200 on user created', async () => {
        ...
        await (0, onboarding_1.signUpCallback)(req, res)(null, []);
    ...
    test('Should return 201 on repeated signup', async () => {
        ...
        const { res } = (0, express_1.getMockRes)();
        await (0, onboarding_1.signUpCallback)(req, res)(null, [user]);
    ...
    test('Should return 400 on error', async () => {
        ...
        const { res } = (0, express_1.getMockRes)();
        try {
            await (0, onboarding_1.signUpCallback)(req, res)(new Error('Error occurred'), []);
        }
        catch (err) {
...
describe('signIn', () => {
    test('Should return 200 on successful authentication', async () => {
        ...
        const { res } = (0, express_1.getMockRes)();
        await (0, onboarding_1.signInCallback)(req, res)(null, [user]);
        expect(res.status).toHaveBeenCalledWith(200);
    });
    test('Should return 404 on user not found', async () => {
        ...
        const { res } = (0, express_1.getMockRes)();
        await (0, onboarding_1.signInCallback)(req, res)(null, []);
    ...
    test('Should return 400 on error', async () => {
        ...
        const { res } = (0, express_1.getMockRes)();
        try {
            await (0, onboarding_1.signInCallback)(req, res)(new Error('Error occurred'), []);
        }
        catch (err) {
            expect(err.message).toBe('Error occurred');
        }
