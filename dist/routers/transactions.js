...
exports.authTransRouter = exports.transactions = void 0;
const express_1 = __importDefault(require("express"));
const middleware_1 = require("../middleware");
const controllers_1 = require("../controllers");
const transactions = express_1.default.Router();
exports.transactions = transactions;
const authTransRouter = express_1.default.Router();
exports.authTransRouter = authTransRouter;
authTransRouter.use(middleware_1.authMiddleware);
/**
 * GET - /transactions
 ...
 *
 */
authTransRouter.get('/', (0, middleware_1.validate)(middleware_1.listTransactionsSchema), controllers_1.listTransactions);
/**
 * GET - /transactions/:id
 ...
 *
 */
authTransRouter.get('/:id', (0, middleware_1.validate)(middleware_1.getTransactionSchema), controllers_1.getTransaction);
/**
 ...
 *
 */
authTransRouter.post('/transfer', (0, middleware_1.validate)(middleware_1.transferTokensSchema), controllers_1.createTransaction);
/**
 ...
 *
 */
authTransRouter.post('/transfer/estimateFee', (0, middleware_1.validate)(middleware_1.estimateTransferTokensSchema), controllers_1.estimateTransferFee);
/*
 ...
 *
 */
transactions.post('/validateAddress', (0, middleware_1.validate)(middleware_1.validateAddressSchema), controllers_1.validateAddress);
